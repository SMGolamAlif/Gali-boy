      ...
      <div className="flex flex-col md:flex-row items-center">
        <div className="md:ml-8">
          <p className="mb-4 text-gray-600 dark:text-gray-400">
            Hi, my name is gali Boy and I'm a web developer. I'm passionate
            about building scalable, efficient and user-friendly web
            applications. I'm also a big fan of open source and I try to
            contribute to the community as much as I can.
          </p>
          <p className="mb-4 text-gray-600 dark:text-gray-400">
            I'm currently working as a freelancer, and I'm open to new projects
            and collaborations. If you need any help or just want to chat, feel
          ...
          <div className="mt-12">
            ...
            <div className="flex space-x-4">
              <a
                ...
                href="https://amethyst-magda-50.tiiny.site"
                target="_blank"
              ...
              <button
                ...
                onClick={() => {
                  ...
                  link.href = "/assets/Galib - Resume.pdf";
                  link.setAttribute("download", "Galib - Resume.pdf");
